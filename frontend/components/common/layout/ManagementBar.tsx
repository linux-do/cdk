              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <button
                      ...
                      className="flex items-center gap-3 rounded-md p-2 text-left hover:bg-muted/50 transition-colors group"
                    >
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    <div className="text-xs text-muted-foreground font-light">版本: 1.2.3</div>
                    <div className="text-xs text-muted-foreground font-light">构建时间: 2026-04-21</div>
